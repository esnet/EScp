...
pub struct file_object {
    ...
    >,
    pub fopendir:
        ::core::option::Option<unsafe extern "C" fn(arg1: ::core::ffi::c_int) -> *mut DIR>,
...
#[test]
fn bindgen_test_layout_sess_info() {
    const UNINIT: ::core::mem::MaybeUninit<sess_info> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<sess_info>(),
        16usize,
        concat!("Size of: ", stringify!(sess_info))
    );
    assert_eq!(
        ::core::mem::align_of::<sess_info>(),
        1usize,
        concat!("Alignment of ", stringify!(sess_info))
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).hdr_type) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(sess_info),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).block_sz) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(sess_info),
...
pub struct file_info {
    pub __bindgen_anon_1: file_info__bindgen_ty_1,
    pub __bindgen_anon_2: file_info__bindgen_ty_2,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union file_info__bindgen_ty_1 {
    pub hdr_type: u8,
    pub offset: u64,
}
#[test]
fn bindgen_test_layout_file_info__bindgen_ty_1() {
    const UNINIT: ::core::mem::MaybeUninit<file_info__bindgen_ty_1> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<file_info__bindgen_ty_1>(),
        8usize,
        concat!("Size of: ", stringify!(file_info__bindgen_ty_1))
    );
    assert_eq!(
        ::core::mem::align_of::<file_info__bindgen_ty_1>(),
        8usize,
        concat!("Alignment of ", stringify!(file_info__bindgen_ty_1))
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).hdr_type) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(file_info__bindgen_ty_1),
            "::",
            stringify!(hdr_type)
        )
    );
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union file_info__bindgen_ty_2 {
    pub block_sz_packed: u8,
    pub file_no_packed: u64,
}
#[test]
fn bindgen_test_layout_file_info__bindgen_ty_2() {
    const UNINIT: ::core::mem::MaybeUninit<file_info__bindgen_ty_2> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<file_info__bindgen_ty_2>(),
        8usize,
        concat!("Size of: ", stringify!(file_info__bindgen_ty_2))
    );
    assert_eq!(
        ::core::mem::align_of::<file_info__bindgen_ty_2>(),
        8usize,
        concat!("Alignment of ", stringify!(file_info__bindgen_ty_2))
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).block_sz_packed) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(file_info__bindgen_ty_2),
            "::",
            stringify!(block_sz_packed)
        )
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).file_no_packed) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(file_info__bindgen_ty_2),
            "::",
            stringify!(file_no_packed)
        )
    );
}
#[test]
...
#[test]
fn bindgen_test_layout_file_info_end() {
    const UNINIT: ::core::mem::MaybeUninit<file_info_end> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<file_info_end>(),
        24usize,
        concat!("Size of: ", stringify!(file_info_end))
    );
    assert_eq!(
        ::core::mem::align_of::<file_info_end>(),
        1usize,
        concat!("Alignment of ", stringify!(file_info_end))
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).hdr_type) as usize - ptr as usize },
        0usize,
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).hdr_sz) as usize - ptr as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(file_info_end),
...
pub struct dtn_args {
    ...
    pub __bindgen_padding_0: [u8; 60usize],
